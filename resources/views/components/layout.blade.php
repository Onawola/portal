            ...
            <div class="carousel-inner">
                <div class="item slider1 active">
                    ...
                    <div class="carousel-caption slider-con">
                        <h2>Welcome to <span>Air Force Comprehensive</span></h2>
                        <p>The Nigerian Air Force (NAF) conceived the idea to establish an Educational cell in the early 70s when it realized the need to provide continuous education for its personnel and their dependants.</p>
                ...
                <div class="item">
                    ...
                    <div class="carousel-caption slider-con">
                        ...
                        <p>This is to inform the general public that application for admission into JSS1 of AFMS, AFGMS Jos and 11 other Air Force Comprehensive/Secondary Schools for...</p>
                ...
                <div class="item">
                    ...
                    <div class="carousel-caption slider-con">
                        <h2>Air Force Comprehensive <span>school</span></h2>
                            ...
                            <form class="col s12" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input type="text" id="name" class="validate @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
